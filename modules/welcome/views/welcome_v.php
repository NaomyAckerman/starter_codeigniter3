					...
					<div class="hero-inner">
						<div class="hero-copy">
							...
							<p class="hero-paragraph is-revealing">
								...
								small footprint, built for developers who need a simple and elegant toolkit to create
						...
						<div class="features-wrap">
							<div class="feature">
								<div class="feature-inner">
									...
									<p class="text-sm mb-0">A pseudo-Latin text used in web design, layout, and printing
										in place of things to emphasise design elements.</p>
								</div>
							</div>
							<div class="feature">
								<div class="feature-inner">
		...
		<footer class="site-footer">
			...
			<div class="container">
				<div class="site-footer-inner has-top-divider">
					<div class="footer-copyright" style="flex-direction: column;">
						&copy; 2024 CodeIgniter Foundation
						<p style="padding: 0;margin: 0;">Page rendered in <strong>{elapsed_time}</strong> seconds.
