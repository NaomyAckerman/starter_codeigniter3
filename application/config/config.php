...
if (is_cli()) {
	...
	$config['base_url'] = env('APP_URL') ?: ($_SERVER['SERVER_NAME'] == 'localhost' ? "{$protocol}{$host}{$path}" : "{$protocol}{$host}");
	// $config['base_url'] = env('APP_URL') ?: "{$protocol}{$host}{$path}";
}
...
|
*/
$config['log_threshold'] = env('LOG_LEVEL', 0);
...
// $config['sess_save_path'] = STORAGEPATH . 'framework/sessions/';
// $config['sess_save_path'] = sys_get_temp_dir(); // on production server
$config['sess_match_ip'] = FALSE;
$config['sess_time_to_update'] = $config['sess_expiration'] / 2;
